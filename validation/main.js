...
function checkEmail() {
  ...
  const email = document.getElementById("email"); // Ensure the email element is selected correctly
  ...
  if (!email.value.match(emailRegex)) {
    ...
    errorTxtEmail.innerText = ""; // Clear any error message when the email is valid
  }
}
